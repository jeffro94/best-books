...
class AmazonScoreToCount extends React.Component {
  ...
  render() {
    ...
    const data = this.props.books.filter(book => book.amz_Rating && book.amz_ReviewCount);
...
export default withRouter(AmazonScoreToCount);
